...
(101, 'John', 'Doe', 120000, '15-03-20 09:00:00', 'Finance'), 
(102, 'Jane', 'Smith', 95000, '15-07-11 09:00:00', 'Operations'), 
(103, 'Alice', 'Johnson', 350000, '15-03-20 09:00:00', 'Finance'), 
(104, 'Bob', 'Brown', 600000, '15-03-20 09:00:00', 'Operations'),
(105, 'Charlie', 'Davis', 600000, '15-07-11 09:00:00', 'Operations'), 
(106, 'Eve', 'Miller', 250000, '15-07-11 09:00:00', 'Sales'), 
(107, 'Frank', 'Wilson', 85000, '15-02-20 09:00:00', 'Sales'), 
(108, 'Grace', 'Lee', 100000, '15-05-11 09:00:00', 'Operations');
...
SELECT * FROM Employee WHERE HIRE_DATE LIKE '15-03%';
